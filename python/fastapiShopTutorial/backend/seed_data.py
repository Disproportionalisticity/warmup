...
"""
Script to fill the DB with mock data
...
def create_categories(db):
    ...
    Returns:
        dict: Dictionary with categories {slug: Category}
    """
    categories_data = [
    ...
    # Refresh categories after commit to get the IDs
...
def create_products(db, categories):
    """
    Creates products in different categories
...
def seed_database():
    """
    Main function that fills the DB
    ...
    try:
        # Check if db is not already filled
